...
with mlflow.start_run(run_name="demo-run-model-1",
...
with mlflow.start_run(tags={"branch": "week2",
    ...
    conda_env = _mlflow_conda_env(
        ...
        # hard coding for now 
        additional_pip_deps=[f"hotel_reservations==0.0.1"],
    ...
    mlflow.pyfunc.log_model(
        ...
        # hard coding for now
        code_paths = [f"../dist/hotel_reservations-0.0.1-py3-none-any.whl"],
        signature=signature
    )
